        ...
        <el-table :data="tableData" border stripe :header-cell-class-name="headerBg"  @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" width="280" align="center">
                <template slot-scope="scope">
                    <el-button type="info" @click="selectMenu(scope.row)">菜单分配<i class="el-icon-menu"></i></el-button>
...
export default {
    ...
    methods: {
        ...
        handleEdit(row){
            this.form = row;
            this.dialogFormVisible = true;
            this.form = JSON.parse(JSON.stringify(row)); //解决编辑未确认就改变的问题
        },
        del(id){
        ...
        delBatch(){
            let ids = this.multipleSelection.map(v => v.id) // [{},{}] -> [1,2] 数组转换成id样式的
        ...
        selectMenu(role) {
         //   this.menuDialogVis = true
            ...
            this.request.get("/role/roleMenu/" + this.roleId).then(res => {
                this.menuDialogVis = true  //先渲染弹窗中的元素
