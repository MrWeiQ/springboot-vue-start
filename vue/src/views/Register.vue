        ...
        <div style="margin: 100px auto; background-color: #fff; width: 400px; height: 600px; padding: 20px; border-radius: 10px">
            ...
            <el-form :model="user" :rules="rules" ref="userForm">
                ...
                <el-form-item prop="nickname">
                    <el-input placeholder="请输入昵称" size="medium" style="margin: 5px 0" prefix-icon="el-icon-s-check" v-model="user.nickname"></el-input>
                </el-form-item>
                ...
                <el-form-item prop="phone">
                    <el-input placeholder="请输入手机号" size="medium" style="margin: 5px 0" prefix-icon="el-icon-phone" v-model="user.phone"></el-input>
                </el-form-item>
                <el-form-item prop="address">
                    <el-input placeholder="地址" size="medium" style="margin: 5px 0" prefix-icon="el-icon-location" v-model="user.address"></el-input>
                </el-form-item>
